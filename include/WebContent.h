...
// This HTML page is served to the client when they access the root URL
// It includes a JavaScript chart for real-time data visualization and control sliders
// for adjusting PID parameters and other settings
