...
\subsubsection{PWM Valve Control and Output Mapping}
\label{sec:valve-mapping}

\paragraph{Physical Valve Characteristics}
...
\paragraph{Output Mapping Function}
...
\paragraph{Dead Zone Threshold Design}
...
\paragraph{Interaction with Anti-Windup}
...
Slider Settings & Gear icon (\texttt{\small \symbol{"2699}}) opens modal to configure min/max/step \\
