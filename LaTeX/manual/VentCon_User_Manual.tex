...
\rohead{\includegraphics[height=1.0em]{pic/VENTREX_Logo_slim.pdf}}
...
\DeclareNewLayer[
  ...
  width=\paperwidth,
  align=bl,
  contents={\includegraphics[width=\paperwidth]{pic/Aalberts_footer.pdf}}
]{footerimage}
...
\DeclareNewLayer[
  ...
  width=\paperwidth,
  align=bl,
  contents={\makebox[\paperwidth][c]{\raisebox{17pt}{\usekomafont{pagefoot}\pagemark}}}
]{footerpagemark}
...
The VentCon demonstrator showcases this principle: it implements the complete control loop on a microcontroller by \textsc{Espressif Systems}, allowing users to observe and tune the regulator's behaviour in real time.
